export default function EditIcon() {
  return (
    <svg aria-hidden="true" fill="none" focusable="false" height="18px" role="presentation" viewBox="0 0 20 20" width="18px">
      ...
      <path d="M9.90833 4.20831C10.2667 6.50831 12.1333 8.26665 14.45 8.49998" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5"></path><path d="M2.5 18.3333H17.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5">
      </path>
    </svg>
  )
}